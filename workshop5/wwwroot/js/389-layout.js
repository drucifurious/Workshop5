...
var wpAjaxUrl='https://www.travelexperts.ca/wp-admin/admin-ajax.php';var flBuilderUrl='https://www.travelexperts.ca/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://www.travelexperts.ca/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://www.travelexperts.ca/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);jQuery(document).on("click",".tte-close-form",function(){jQuery(this).parents(".tte-overlay-contact-form").fadeOut(200);jQuery(".fl-builder-content[data-overlay='1']:not(.fl-theme-builder-header-sticky)").css("z-index","100");});jQuery(document).on("click",".tte-open-overlay-form",function(e){e.preventDefault();jQuery(".tte-overlay-contact-form").css("display","flex").hide().fadeIn(200);jQuery(".fl-builder-content[data-overlay='1']:not(.fl-theme-builder-header-sticky)").css("z-index","1");});jQuery("head").append('<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">');